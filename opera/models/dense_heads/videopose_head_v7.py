...
# 添加时间 2024-10-7 适用于只在Pose-decoder中进行时空编码模块
# 1.将从encoder中得到的初始参考点损失从l1_loss + cls_loss 修改为 rle_loss + cls_loss
# 2.将Pose-deocder每层中得到的回归结果损失从l1_loss + cls_loss 修改为 rle_loss + cls_loss
@HEADS.register_module()
class VideoPoseHeadV7(AnchorFreeHead):
