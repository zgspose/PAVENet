...
# 添加时间 2024-10-21 only pose-decoder 时空解码 无joint-decoder
# match_loss: cls loss + rle loss
# total_loss: cls loss + rle loss
@HEADS.register_module()
class VideoPoseHeadV15(AnchorFreeHead):
    ...
    def get_targets(self,
        ...
        (labels_list, label_weights_list, kpt_targets_list, kpt_weights_list,
         area_targets_list, pos_inds_list, neg_inds_list) = multi_apply(
             self._get_target_single, cls_scores_list, kpt_preds_list, sigmas_pred_list,
