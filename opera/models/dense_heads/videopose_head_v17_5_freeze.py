...
class VideoPoseHeadV17_5_freeze(AnchorFreeHead):
    ...
    def _init_layers(self):
        ...
        for kpt in self.kpt_branches:
            for param in kpt.parameters():
                param.requires_grad = False
        for kpt in self.pre_kpt_branches:
            for param in kpt.parameters():
                param.requires_grad = False
        for kpt in self.next_kpt_branches:
            for param in kpt.parameters():
                param.requires_grad = False
        for sigma in self.dec_fc_sigma_branches:
        ...
        for param in self.fc_hm.parameters():
            param.requires_grad = False
        for param in self.dec_flow.parameters():
                param.requires_grad = False
