...
# encoder:
#           loss = l1 loss
# joint-decoder初始仍使用pose-decoder的当前帧的结果，每层回归采样点偏移+参考点偏移
@HEADS.register_module()
class VideoPoseHeadV17_6(AnchorFreeHead):
    ...
    def forward_refine(self, memory, mlvl_masks, refine_targets, losses,
        ...
        if pos_inds.sum() == 0:
            ...
            pos_kpt_preds = torch.concat([kpt_preds[pos_inds], kpt_preds[pos_inds], kpt_preds[pos_inds]], dim=0)
