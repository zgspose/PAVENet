...
class VideoPoseHeadV11_13_5_unfreeze(AnchorFreeHead):
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        if self.as_two_stage:
            return outputs_classes, outputs_kpts, output_sigmas, \
                ...
                hm_proto, memory, mlvl_masks, pre_pre_pose_kpt, pre_pose_kpt, next_pose_kpt, next_next_pose_kpt
        else:
            raise RuntimeError('only "as_two_stage=True" is supported.')
    ...
    def _get_bboxes_single(self,
        ...
        refine_outputs = self.forward_refine(memory, mlvl_masks, pre_pre_pose_kpt, pre_pose_kpt, next_pose_kpt, next_next_pose_kpt,
