...
# 添加时间 2024-8-15 适用于pose-tracking 模块, 修改前后帧提取pose-token所使用的pose-token
@HEADS.register_module()
class VideoPoseHeadV3(AnchorFreeHead):
    ...
    def forward_refine(self, memory, mlvl_masks, 
        ...
        hs, ref = self.transformer.pose_tracking(
            ...
            query_pos=torch.stack([now_frame_pose_query_pos, now_frame_pose_query_pos], dim=1).flatten(0, 1)[None],
