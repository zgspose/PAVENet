...
class PosetrackVideoPoseDataset(CustomDataset):
    ...
    def evaluate(self,
        ...
        # coco_dt = self.coco.loadRes("2025_2_13_resnet50_num_frames_3_posetrack18.keypoints.json")
        ...
        for key in out_data.keys():
            ...
            frame_ids = [i for i in range(1, num_frames+1)] # psoetrack17
            ...
            for frame_id in frame_ids:
                if frame_id not in used_frame_ids:
                    annorect = []
                    img_sfx = arrs[0] + '/' + arrs[1] + '/' + str(frame_id).zfill(8) + '.jpg' # posetrack17
                    # img_sfx = arrs[0] + '/' + arrs[1] + '/' + arrs[2] + '/' + str(frame_id).zfill(6) + '.jpg' # posetrack18
                    annorect.append({
                        'annopoints': [{'point': [{
                            'id': [0],
                            'x': [0],
        ...
        for vname in out_data.keys():
            ...
            outfpath = os.path.join(output_dir, out_filenames[os.path.join('images', vname)]) # posetrack17
            # outfpath = os.path.join(output_dir, out_filenames[vname]) # posetrack18
