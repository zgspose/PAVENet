...
class PosetrackVideoPoseDatasetV2(CustomDataset):
    """
        PoseTrack Dataset
    """
    """
    ...
    def __init__(self,
                 ...
                 **kwargs):
        self.num_frames = 5
        super(PosetrackVideoPoseDatasetV2, self).__init__(*args, **kwargs)
    ...
    def _get_auxiliary_frames(self, img_index):
        ...
        if self.num_frames == 5:
            # prev_prev_frame = prev_frame = now_frame
            if current_idx == 1:
                prev_prev_delta = 0
                prev_delta = 0
                next_delta = 1
            ...
            # prev_prev_frame = prev_frame
                ...
                next_delta = 1
                next_next_delta = 2
            # next_next_frame = next_frame
            elif current_idx == info['nframes'] - 1:
                prev_prev_delta = 2
                prev_delta = 1
                next_delta = 1
                next_next_delta = 1
            # next_next_frame = next_frame = now_frame
            elif current_idx == info['nframes']:
                prev_prev_delta = 2
                prev_delta = 1
                next_delta = 0
                next_next_delta = 0
                ...
                next_delta = 1
                next_next_delta = 2
        prev_prev_idx = current_idx - prev_prev_delta
        prev_idx = current_idx - prev_delta
        next_idx = current_idx + next_delta
        next_next_idx = current_idx + next_next_delta
        
        now_image_file = image_file_path
        prev_prev_image_file = osp.join(osp.dirname(image_file_path), str(prev_prev_idx).zfill(zero_fill) + '.jpg')
        ...
        next_next_image_file = osp.join(osp.dirname(image_file_path), str(next_next_idx).zfill(zero_fill) + '.jpg')
        
        return [prev_prev_image_file, prev_image_file, now_image_file, next_image_file, next_next_image_file]
    ...
    def _get_data(self):
        ...
        for img_index in self.img_ids:
            ...
            info['filename_prev_prev'] = imgs[0]
            info['filename_prev'] = imgs[1]
            info['filename_now'] = imgs[2]
            info['filename_next'] = imgs[3]
            info['filename_next_next'] = imgs[4]
