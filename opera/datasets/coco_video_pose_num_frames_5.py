...
# 基于coco数据集，模拟时序，构建时序视频样本, 单样本包含五帧
@DATASETS.register_module()
class CocoVideoPoseDataset5(CocoDataset):
    """
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(CocoVideoPoseDataset5, self).__init__(*args, **kwargs)
    ...
    def load_annotations(self, ann_file):
        ...
        for i in self.img_ids:
            ...
            # 均使用当前帧来模拟辅助帧
            info['filename_now'] = info['file_name']
            # 前前帧
            info['filename_prev_prev'] = info['file_name']
            # 前帧
            info['filename_prev'] = info['file_name']
            # 后帧
            info['filename_next'] = info['file_name']
            # 后后帧
            info['filename_next_next'] = info['file_name']
    ...
    def _parse_ann_info(self, img_info, ann_info):
        ...
        seg_map = img_info['filename_now'].replace('jpg', 'png')
