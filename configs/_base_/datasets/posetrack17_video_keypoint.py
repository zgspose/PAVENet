...
data = dict(
    ...
    test=dict(
        ...
        img_prefix=data_root + 'images_renamed/',
        pipeline=test_pipeline))
evaluation = dict(interval=1, metric='keypoints',jsonfile_prefix='2025_5_11_res50_num_frames_3_posetrack17_layer_num_5')
