...
data = dict(
    ...
    test=dict(
        ...
        img_prefix=data_root + 'images/',
        pipeline=test_pipeline))
# evaluation = dict(interval=1, metric='keypoints',jsonfile_prefix="2025_1_5_single_frame_posetrack18_res50")
# evaluation = dict(interval=1, metric='keypoints',jsonfile_prefix="2025_1_5_single_frame_posetrack18_hrnet")
evaluation = dict(interval=1, metric='keypoints',jsonfile_prefix="2025_1_5_single_frame_posetrack18_swin")
