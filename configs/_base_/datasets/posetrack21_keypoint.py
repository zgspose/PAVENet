...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'posetrack18_json_files/posetrack_train_fixed.json',
        img_prefix=data_root + 'images/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        samples_per_gpu=1,
        ann_file=data_root + 'posetrack18_json_files/posetrack_val_fixed.json',
        img_prefix=data_root + 'images/',
    ...
    test=dict(
        ...
        img_prefix=data_root + 'images/',
        pipeline=test_pipeline))
# evaluation = dict(interval=1, metric='keypoints',jsonfile_prefix="2025_1_5_single_frame_posetrack21_res50")
# evaluation = dict(interval=1, metric='keypoints',jsonfile_prefix="2025_1_5_single_frame_posetrack21_hrnet")
evaluation = dict(interval=1, metric='keypoints',jsonfile_prefix="2025_1_5_single_frame_posetrack21_swin")
