...
# hrnetw48 --- todo
# swin-L ----- running
dataset_type = 'opera.CocoVideoPoseDataset'   # 单样本包含多帧图片---连续三帧
...
train_pipeline = [
    dict(type='mmdet.LoadMulImageFromFileForCocoFrames3', to_float32=True),
...
data = dict(
    ...
    test=dict(
        ...
        img_prefix=data_root + 'images/val2017/',
        pipeline=test_pipeline))
# evaluation = dict(interval=1, metric='keypoints',jsonfile_prefix='petr_resnet50_num_frame_3_bs16_20e_coco_rle')
evaluation = dict(interval=1, metric='keypoints',jsonfile_prefix='petr_swin_num_frame_3_bs16_20e_coco_rle')
