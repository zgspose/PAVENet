...
data_root = '/root/autodl-tmp/datasets/posetrack18/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'posetrack18_json_files/posetrack_train_refixed.json',
        img_prefix=data_root,
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        samples_per_gpu=1,
        ann_file=data_root + 'posetrack18_json_files/posetrack_val_refixed.json',
        img_prefix=data_root,
    ...
    test=dict(
        ...
        img_prefix=data_root,
        pipeline=test_pipeline))
evaluation = dict(interval=1, metric='keypoints',jsonfile_prefix='inference_swin_num_frames_3_posetrack18')
# evaluation = dict(interval=1, metric='keypoints',jsonfile_prefix='2025_2_13_resnet50_num_frames_3_posetrack18_v1')
