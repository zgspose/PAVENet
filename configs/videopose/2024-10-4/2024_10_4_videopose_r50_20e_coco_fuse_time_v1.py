            ...
            decoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        ...
                        # 新模块
                        dict(
                            type='opera.MulFramesMultiScaleDeformablePoseAttention',
                            num_points=15,
                            embed_dims=256)
                    ],
                    feedforward_channels=1024,
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            'pre_sampling_offsets': dict(lr_mult=0.1),
            'now_sampling_offsets': dict(lr_mult=0.1),
            'next_sampling_offsets': dict(lr_mult=0.1),
