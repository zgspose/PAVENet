...
model = dict(
    ...
    init_cfg=dict(type='Pretrained', checkpoint='checkpoints/modify_posetrack_single_frame_rle.pth'),
    backbone=dict(
        type='mmdet.ResNet',
    ...
    bbox_head=dict(
        ...
        as_two_stage=True,
        transformer=dict(
            type='opera.VideoPoseTransformerV1',
            num_keypoints=15,
            encoder=dict(
            ...
            decoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    feedforward_channels=1024,
                    ffn_dropout=0.1,
                    operation_order=('self_attn', 'norm', 'time_attn', 'norm', 'cross_attn', 'norm',
                                     'ffn', 'norm'))),
            hm_encoder=dict(
                type='mmcv.DetrTransformerEncoder',
                num_layers=1,
