...
# only use pose-decoder，pose-decoder使用rle损失
model = dict(
    type='opera.VideoPoseV1',
    # 加载预训练权重  ----- 在posetrack单帧上使用rle训练好的模型权重
    ...
    neck=dict(
        ...
        num_outs=4),
    bbox_head=dict(
        type='opera.VideoPoseHeadV14_2_num_frame_5',
        num_keypoints=15,
        num_query=300,
        ...
        transformer=dict(
            # 输入为5帧
            type='opera.VideoPoseTransformerV14_2',
            num_keypoints=15,
            encoder=dict(
