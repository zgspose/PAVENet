_base_ = [
    '../../_base_/datasets/test_video_keypoint.py', '../../_base_/default_runtime.py'
]
# backbone + encoder 训练
...
model = dict(
    ...
    init_cfg=dict(type='Pretrained', checkpoint='pretrain_checkpoints/swin_coco_rle_frames3_15keypoints.pth'),
    backbone=dict(
