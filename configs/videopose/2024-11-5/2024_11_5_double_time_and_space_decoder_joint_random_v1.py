...
model = dict(
    ...
    bbox_head=dict(
        ...
        as_two_stage=True,
        transformer=dict(
            type='opera.VideoPoseTransformerV17_4',
            num_keypoints=15,
            num_frames=3,
            encoder=dict(
            ...
            refine_decoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        ...
                        # 使用不同的线性层
                        dict(
                            type='mmcv.MulFramesMultiScaleDeformableAttentionV17',
                            embed_dims=256,
                            im2col_step=128)
                    ],
                    feedforward_channels=1024,
        ...
        loss_cls=dict(
            ...
            loss_weight=2.0),
        # encoder: 3
        loss_kpt=dict(type='opera.RLELoss', loss_weight=0.1, joints_weight=[1., 1., 1., 1., 1., 1.2, 1.2, 1.5, 1.5, 1., 1., 1.2, 1.2, 1.5, 1.5]),
        loss_kpt_rpn=dict(type='opera.RLELoss', loss_weight=0.1),
        ...
        loss_kpt_refine=dict(type='opera.RLELoss', loss_weight=0.1, joints_weight=[1., 1., 1., 1., 1., 1.2, 1.2, 1.5, 1.5, 1., 1., 1.2, 1.2, 1.5, 1.5]),
