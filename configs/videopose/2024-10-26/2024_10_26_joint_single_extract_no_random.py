...
model = dict(
    ...
    # pose-decoder时空解码预训练 --- work_dirs/2024_10_21_videopose_r50_20e_coco_fuse_time_v1/epoch_8.pth
    ...
    bbox_head=dict(
        ...
        as_two_stage=True,
        transformer=dict(
            type='opera.VideoPoseTransformerV18_1',
            num_keypoints=15,
            encoder=dict(
