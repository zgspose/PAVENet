...
model = dict(
    ...
    # 加载预训练权重  ----- 使用posetrack单帧训练好的权重
    init_cfg=dict(type='Pretrained', checkpoint='work_dirs/single_frame_posetrack_11_1_res50/epoch_24.pth'),
    backbone=dict(
        type='mmdet.ResNet',
    ...
    neck=dict(
        ...
        num_outs=4),
    bbox_head=dict(
        type='opera.VideoPoseHeadV11_13_5_unfreeze',
        num_frames=5,
        num_keypoints=15,
        num_query=300,
        ...
        as_two_stage=True,
        transformer=dict(
            type='opera.VideoPoseTransformerV11_9_1_unfreeze',
            num_frames=5,
            num_keypoints=15,
            encoder=dict(
            ...
            decoder=dict(
                type='opera.VideoPoseTransformerDecoderV2_1',
                num_keypoints=15,
                num_layers=3,
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        ...
                        # 时空解码
                        dict(
                            type='opera.MulFramesMultiScaleDeformablePoseAttentionV5_num_frame_5',
                            num_points=15,
                            embed_dims=256)
                    ],
                    feedforward_channels=1024,
        ...
        loss_kpt_refine=dict(type='opera.RLELoss', loss_weight=1.2, joints_weight=[1., 1., 1., 1., 1., 1.2, 1.2, 1.5, 1.5, 1., 1., 1.2, 1.2, 1.5, 1.5]),
