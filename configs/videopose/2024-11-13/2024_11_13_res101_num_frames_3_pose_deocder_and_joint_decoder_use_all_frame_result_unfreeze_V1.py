...
model = dict(
    ...
    init_cfg=dict(type='Pretrained', checkpoint='work_dirs/single_frame_posetrack_11_12_res101/epoch_27.pth'),
    backbone=dict(
        type='mmdet.ResNet',
    ...
    neck=dict(
        ...
        num_outs=4),
    bbox_head=dict(
        type='opera.VideoPoseHeadV11_9_2_unfreeze',
        num_keypoints=15,
        num_query=300,
        ...
        loss_kpt_refine=dict(type='opera.RLELoss', loss_weight=0.8, joints_weight=[1., 1., 1., 1., 1., 1.2, 1.2, 1.5, 1.5, 1., 1., 1.2, 1.2, 1.5, 1.5]),
