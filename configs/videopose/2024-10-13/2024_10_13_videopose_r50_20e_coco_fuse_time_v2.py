...
model = dict(
    ...
    bbox_head=dict(
        ...
        as_two_stage=True,
        transformer=dict(
            type='opera.VideoPoseTransformerV9',
            num_keypoints=15,
            encoder=dict(
            ...
            decoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    operation_order=('self_attn', 'norm', 'cross_attn', 'norm', 
                                     'ffn', 'norm'))),
            # pose时序信息融合模块 --- 2024-10-13
            fuse_time_after_decoder=dict(
                type='mmcv.DetrTransformerEncoder',
                num_layers=1,
                transformerlayers=dict(type='mmcv.BaseTransformerLayer',
                        ...
                        ffn_dropout=0.1,
                        operation_order=('self_attn', 'norm', 'ffn', 'norm'))),
            # pose空间信息融合模块 --- 2024-10-13
            fuse_space_after_decoder=dict(
                type='mmcv.DetrTransformerEncoder',
                num_layers=1,
                transformerlayers=dict(type='mmcv.BaseTransformerLayer',
                        attn_cfgs= dict(
