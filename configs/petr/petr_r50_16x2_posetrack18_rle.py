...
model = dict(
    ...
    neck=dict(
        ...
        num_outs=4),
    bbox_head=dict(
        type='opera.VedPoseHeadV3', # encoder、pose-decoder and joint-decoder all use rle-loss
        num_query=300,
        num_classes=1,  # only person
        in_channels=2048, # no use
