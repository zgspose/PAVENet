_base_ = [
    '../../_base_/datasets/coco_video_keypoint_num_frames_3.py', '../../_base_/default_runtime.py'
]
# 添加时间-2024-12-2 添加随机数据增强 --- 随机旋转 +- x度
model = dict(
    type='opera.PETR',
    # 使用原始petr在coco上训练得到的权重，17个关节点
    init_cfg=dict(type='Pretrained', checkpoint='pretrain_checkpoints/petr_swin-l-p4-w7_16x1_100e_coco.pth'),
    backbone=dict(
