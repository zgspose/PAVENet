...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=2.0),
        loss_kpt=dict(type='opera.RLELoss', loss_weight=0.5),
        loss_kpt_rpn=dict(type='opera.RLELoss', loss_weight=0.5),
        loss_oks=dict(type='opera.OKSLoss', num_keypoints=17, loss_weight=0.0),
        loss_hm=dict(type='opera.CenterFocalLoss', loss_weight=0.0),
        loss_kpt_refine=dict(type='opera.RLELoss', loss_weight=0.5),
